...
\begin{itemize}
  \item Refer to the \textsc{Homework5\_Questions\_Template} for information on Q7 of the Homework 5 written questions. Please submit this file to Gradescope under the Homework 5 Written (Numpy)	assignment along with your completed \texttt{model.py}
